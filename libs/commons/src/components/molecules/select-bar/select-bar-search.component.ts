...
@Component({
  selector: 'claro-select-bar',
  templateUrl: './select-bar-search.component.html',
  styleUrls: ['./select-bar-search.component.scss'],
})
export class SelectBarComponent implements OnInit, OnChanges {
  @Input() value: any = '';
